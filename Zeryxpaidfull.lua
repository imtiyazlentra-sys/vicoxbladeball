...
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/KingScript663/bbb/refs/heads/main/NatureHub0.lua"))()
local UI = Library.new()
UI:load()

-- Tab
local BlatantTab = UI:create_tab("Blatant", "rbxassetid://10734962068")
local PlayerTab = UI:create_tab("Player", "rbxassetid://10747373176")
local WorldTab = UI:create_tab("World", "rbxassetid://10723415040")
        ...
        if value then
            Connections_Manager['Auto Parry'] = RunService.PreSimulation:Connect(function()
                ...
                for _, Ball in pairs(Balls) do
                    ...
                    local Parry_Accuracy = Ping_Threshold + math.max(Speed / 2.2, 9.5)
...
AutoParryModule:create_checkbox({
    title = "Randomize Parry Accuracy",
...
local ManualSpamModule = BlatantTab:create_module({
...
local DetModule = BlatantTab:create_module({
    title = "Detections",
    description = "Ability Responses",
    section = "right",
    flag = "Detec_tion",
    callback = function(state)
     end
...
DetModule:create_checkbox({
    title = "Anti Phantom",
    flag = "toggle_anti_phantom",
    callback = function(value)
...
DetModule:create_checkbox({
    title = "Anti Death Slash",
    flag = "toggle_anti_death_slash",
    callback = function(state)
     end
})

DetModule:create_checkbox({
    title = "Anti Time Hole",
    flag = "toggle_anti_time",
    callback = function(state)
     end
})

DetModule:create_checkbox({
    title = "Anti Slash of Fury",
    flag = "toggle_anti_fury",
    callback = function(state)
     end
})

DetModule:create_checkbox({
    title = "Anti Telekinesis",
    flag = "toggle_anti_telekinesis",
    callback = function(state)
     end
})
...
local AbilityModule = PlayerTab:create_module({
    title = "Ability ESP",
...
local BallTrailModule = WorldTab:create_module({
    title = "Ball Trail",
    description = "Add White Line As The Ball Moves",
    section = "left",
    flag = "trial_ball",
    callback = function(value)
       if value then
...
local VisualizeModule = WorldTab:create_module({
    title = "Visualize",
